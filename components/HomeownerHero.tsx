...
export const HomeownerHero: React.FC = () => {
  return (
    <section className="relative z-30 min-h-[85vh] flex items-center bg-[#f2f2f2] shadow-[0_-25px_50px_-12px_rgba(0,0,0,0.3)] overflow-hidden rounded-t-[3rem] -mt-16 sticky top-0">
